// --- adicionar no topo de cada ficheiro js (ex.: equipa.js -> TABLE_NAME = 'equipa') ---
const TABLE_NAME = 'equipa'; // exemplo: 'equipa', 'arbitro', 'capitao', 'treinador', 'jogo', 'resumo'
...
async function loadFromDB() {
  ...
  renderTable(data);
  snapshot = structuredClone(data); // estado basiie vindo da BD
